...
choose(80, 70) * .1 ^ 80 + choose(80, 80) * .1 ^ 8 

pbinom((70:80), size = 8, prob = .5, lower.tail = FALSE)
...
#Se supone que el número de personas que se presentan en una parada de autobús es Poisson con una media de 5 5 personas por hora. Miras la parada de autobús durante 3 horas. ¿Sobre cuál es la probabilidad de ver 10 o menos personas?
